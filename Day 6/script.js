...
// let studentGrade = 3.5;
// if (studentGrade > 3.5 || teacher == "Captain Awesome"){
...
let pRaces = ["Human", "Orc", "Elf", "Tauren", "Gnome"];
let pClasses = ["Warrior", "Mage", "Shaman", "Rogue", "Priest", "Paladin"];
let pWeapons = ["Staff", "Dagger", "Sword", "Hammer", "Wand", "Bow & Arrow", "Blunderbuss"];

let player1 = new Player(1, "Ninjafiveo", pClasses[1], pRaces[3], 100, pWeapons[0]);
let player2 = new Player(2, "Hitogoroshi", pClasses[3], pRaces[4], 125, pWeapons[1]);
